<%-- 
    ...
    Created on : 20/12/2022, 12:47:21
    Author     : Usuario
--%>
        ...
        <div class="container" >
            <h1 class="text-center" >Modificar Socio</h1>
                <div class="row" >
                    ...
                    <!<!-- codigo java -->
                    <%
                        //metodo para obtener el parametro de la url - siempre viene como string// 
				String id=request.getParameter("id");
				int mid;
				mid=Integer.parseInt(id);				
				Socios resultado=null;
				SociosDAO  s1=new SociosDAO();
                        // llamo al metodo de consulta id para completar el form //
				resultado=s1.mostrarSocio(mid);				
		    %>
                    <form class="p-5" method="POST" action="SociosController?accion=actualizar">
                         <div class="mb-2">
                            <!<!-- en value devuelvo el campo que obtuve del metodo, atravez de los getter  -->
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control" id="mail" name="email" value=<%=resultado.getEmail()%>  >                          
                        </div>  
                        <div class="mb-2">
